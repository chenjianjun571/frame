...
ifeq ($(COMPILE),release)
    NDEBUG=1
    DEBUG_DEFINE=-D_DEBUG_STACK -rdynamic -D_LANG_CH_US -DENDECRYPT_DLL -DMYSQLPP_MYSQL_HEADERS_BURIED -DHAVE_NETINET_IN_H -DHAVE_INTTYPES_H -std=c++11
else
    #NDEBUG=1
    DEBUG_DEFINE=-D_DEBUG_STACK -rdynamic -D_LANG_CH_US -DENDECRYPT_DLL -DMYSQLPP_MYSQL_HEADERS_BURIED -DHAVE_NETINET_IN_H -DHAVE_INTTYPES_H -std=c++11
endif
...
ifdef NDEBUG
 # release库依赖添加
 LIB=-lframe -lglog -lACE -levent -levent_pthreads -lmysqlclient -lmysqlpp -lprotobuf-lite -lthriftnb -lthrift -lrt
