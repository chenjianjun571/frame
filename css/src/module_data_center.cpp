...
ModuleDataCenter::ModuleDataCenter()
    :_recv_cond_variable(jsbn::ConditionVariable::Create())
{}

ModuleDataCenter::~ModuleDataCenter()
{
    _recv_data_lists.clear();
    delete _recv_cond_variable;
}

int ModuleDataCenter::PutProtocolData(sProtocolData_ptr& pData)
{
...
sProtocolData_ptr ModuleDataCenter::GetProtocolData(unsigned long max_time_inMS)
{
    jsbn::CriticalSectionScoped css(&_recv_critical_section);
